...
export function IndustryCards() {
  return (
    <section id="industries" className="scroll-mt-24 bg-white px-5 py-24 md:px-8 md:py-36" aria-labelledby="ind-heading">
      <div className="mx-auto max-w-[1440px]">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {industries.map((item, index) => (
            <DynamicCard key={item.name} delay={index * 0.05}>
              ...
              <a className="mt-6 inline-flex min-h-10 items-center text-sm text-sf-blue transition-transform group-hover:translate-x-1" href="#crate">
                Explore workflow →
              </a>
            </DynamicCard>
          ))}
